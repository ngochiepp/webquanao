!(function (n) {
  ...
  var e,
    t = document.body.getAttribute("data-topbar");
  function s(e) {
    1 == n("#light-mode-switch").prop("checked") && "light-mode-switch" === e
      ...
      ? (1 == n("#rtl-mode-switch").prop("checked")
        ...
        "dark" == t && document.body.setAttribute("data-sidebar", "light"),
        ...
        e.forEach(function (t) {
          t.querySelectorAll(".dropdown-menu .dropdown-item").forEach(function (
            ...
            e.addEventListener("click", function () {
              (t.querySelector(".user-name-text").innerHTML =
                e.querySelector(".dropdown-name").innerHTML),
                (t.querySelector(".user-sort-name").innerHTML = e.querySelector(
                  ".dropdown-sort-name"
                ).innerHTML),
                (t.querySelector(".user-name-sub-text").innerHTML =
                  e.querySelector(".dropdown-sub-desc").innerHTML);
            });
          });
        });
    })(),
    ...
    window.sessionStorage &&
      ((e = sessionStorage.getItem("is_visited"))
        ...
        ? (sessionStorage.setItem("is_visited", "rtl-mode-switch"),
          n("#light-mode-switch").prop("checked", !1),
          n("#dark-mode-switch").prop("checked", !1),
          n("#rtl-mode-switch").prop("checked", !0))
        : sessionStorage.setItem("is_visited", "light-mode-switch")),
