...
<!-- Mirrored from themesdesign.in/tocly/layouts/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 Jun 2024 12:01:00 GMT -->
                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        <a href="index.html" class="logo logo-dark">
                            ...
                            <span class="logo-lg">
                                <img src="./assets/admin/images/logo-sm-dark.png" alt="logo-dark" height="25">
                            </span>
                        </a>
                        ...
                        <a href="index.html" class="logo logo-light">
                            ...
                            <span class="logo-lg">
                                <img src="./assets/admin/images/logo-sm-light.png" alt="logo-light" height="25">
                            </span>
                        </a>
                    </div>
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0" aria-labelledby="page-header-notifications-dropdown">
                            ...
                            <div data-simplebar style="max-height: 230px;">
                                ...
                                <a href="#" class="text-reset notification-item">
                                    <div class="d-flex">
                                        <img src="./assets/admin/images/users/avatar-4.jpg" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                        <div class="flex-1">
        ...
        <div class="vertical-menu">
            ...
            <div class="navbar-brand-box">
                <a href="index.html" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="./assets/admin/images/logo-dark.png" alt="logo-dark" height="22">
                    </span>
                </a>
                ...
                <a href="index.html" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="./assets/admin/images/logo-light.png" alt="logo-light" height="22">
                    </span>
                </a>
            </div>
            ...
            <div class="dropdown px-3 sidebar-user sidebar-user-info">
                <button type="button" class="btn w-100 px-0 border-0" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                            <img src="./assets/admin/images/users/avatar-2.jpg" class="img-fluid header-profile-user rounded-circle" alt="">
                        </div>
                                ...
                                <div class="card-body pt-2">
                                    <div class="table-responsive" data-simplebar style="max-height: 358px;">
                                        <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                            <tbody>
                                                <tr>
                                                    <td style="width: 20px;"><img src="./assets/admin/images/users/avatar-4.jpg" class="avatar-sm rounded-circle " alt="..."></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><img src="./assets/admin/images/users/avatar-5.jpg" class="avatar-sm rounded-circle " alt="..."></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><img src="./assets/admin/images/users/avatar-6.jpg" class="avatar-sm rounded-circle " alt="..."></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><img src="./assets/admin/images/users/avatar-7.jpg" class="avatar-sm rounded-circle " alt="..."></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><img src="./assets/admin/images/users/avatar-8.jpg" class="avatar-sm rounded-circle " alt="..."></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><img src="./assets/admin/images/users/avatar-2.jpg" class="avatar-sm rounded-circle " alt="..."></td>
                                                    <td>
                                                        <h6 class="font-size-15 mb-1">Marie Kim</h6>
                                                ...
                                                <tr>
                                                    <td><img src="./assets/admin/images/users/avatar-1.jpg" class="avatar-sm rounded-circle " alt="..."></td>
                                                    <td>
                                                        <h6 class="font-size-15 mb-1">Sonya Henshaw</h6>
                                                        <p class="text-muted mb-0 font-size-14">sonyahenshaw@tocly.com</p>
                                                    </td>
                                        ...
                                        <table class="table align-middle table-nowrap mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><img src="./assets/admin/images/users/avatar-2.jpg" class="avatar-xs rounded-circle me-2" alt="..."> Neal Matthews</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="./assets/admin/images/users/avatar-3.jpg" class="avatar-xs rounded-circle me-2" alt="..."> Jamal Burnett</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="./assets/admin/images/users/avatar-4.jpg" class="avatar-xs rounded-circle me-2" alt="..."> Juan Mitchell</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="./assets/admin/images/users/avatar-5.jpg" class="avatar-xs rounded-circle me-2" alt="..."> Barry Dick</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="./assets/admin/images/users/avatar-6.jpg" class="avatar-xs rounded-circle me-2" alt="..."> Ronald Taylor</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="./assets/admin/images/users/avatar-7.jpg" class="avatar-xs rounded-circle me-2" alt="..."> Jacob Hunter</td>
                                                    <td>
    ...
    <div class="right-bar">
        <div data-simplebar class="h-100">
            ...
            <div class="p-4">
                ...
                <div class="form-check form-switch mb-3">
                    <input class="form-check-input theme-choice" type="checkbox" id="dark-mode-switch" data-bsStyle="./assets/admin/css/bootstrap-dark.min.css" data-appStyle="./assets/admin/css/app-dark.min.html">
...
<!-- Mirrored from themesdesign.in/tocly/layouts/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 Jun 2024 12:01:04 GMT -->
