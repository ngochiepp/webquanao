...
<body data-sidebar="colored">
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-none d-sm-inline-block">
                        <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown"
                            ...
                            <img class="" src="./assets/admin/images/flags/us.jpg" alt="Header Language"
                                height="16">
                        </button>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-shrink-0 align-self-start">
                                            <div class="dropdown">
                                                <a class="dropdown-toggle btn-icon border rounded-circle"
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 overflow-hidden ms-4">
                                            ...
                                            <p class="text-muted mb-0 text-truncate"><span
                                                    class="badge bg-subtle-success text-success font-size-12 fw-normal me-1"><i
                                                        class="mdi mdi-arrow-top-right"></i> 23% Increase</span> vs
                                                last month</p>
                                        </div>
                                        <div class="flex-shrink-0 align-self-start">
                                            <div class="dropdown">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="width: 20px;"><img
                                                            src="./assets/admin/images/users/avatar-4.jpg"
                                                ...
                                                <tr>
                                                    <td><img src="./assets/admin/images/users/avatar-5.jpg"
                                                            class="avatar-sm rounded-circle " alt="..."></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><img src="./assets/admin/images/users/avatar-6.jpg"
                                                            class="avatar-sm rounded-circle " alt="..."></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><img src="./assets/admin/images/users/avatar-7.jpg"
                                                            class="avatar-sm rounded-circle " alt="..."></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><img src="./assets/admin/images/users/avatar-8.jpg"
                                                            class="avatar-sm rounded-circle " alt="..."></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><img src="./assets/admin/images/users/avatar-2.jpg"
                                                            class="avatar-sm rounded-circle " alt="..."></td>
                                                    <td>
                                                        <h6 class="font-size-15 mb-1">Marie Kim</h6>
                                                ...
                                                <tr>
                                                    <td><img src="./assets/admin/images/users/avatar-1.jpg"
                                                            class="avatar-sm rounded-circle " alt="..."></td>
                                                    <td>
                                                        <h6 class="font-size-15 mb-1">Sonya Henshaw</h6>
                                                        <p class="text-muted mb-0 font-size-14">sonyahenshaw@tocly.com
                                        ...
                                        <table class="table align-middle table-nowrap mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="./assets/admin/images/users/avatar-3.jpg"
                                                            class="avatar-xs rounded-circle me-2" alt="...">
                                                        Jamal Burnett</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="./assets/admin/images/users/avatar-4.jpg"
                                                            class="avatar-xs rounded-circle me-2" alt="...">
                                                        Juan Mitchell</td>
                                                    <td>
    ...
    <div class="right-bar">
        <div data-simplebar class="h-100">
            ...
            <div class="p-4">
                <div class="mb-2">
                    <img src="./assets/admin/images/layouts/layout-1.jpg" class="img-fluid img-thumbnail"
                        alt="layout-1">
                </div>
                ...
                <div class="mb-2">
                    <img src="./assets/admin/images/layouts/layout-2.jpg" class="img-fluid img-thumbnail"
                        alt="layout-2">
                </div>
                <div class="form-check form-switch mb-3">
                ...
                <div class="mb-2">
                    <img src="./assets/admin/images/layouts/layout-3.jpg" class="img-fluid img-thumbnail"
                        alt="layout-3">
                </div>
